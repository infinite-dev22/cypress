...
[Code of Conduct](https://github.com/CyconeraInc/cypress/blob/main/CODE_OF_CONDUCT.md).
...
Before you ask a question, it is best to search for existing [Issues](https://github.com/CyconeraInc/cypress/issues)
that might help you. In case you have found a suitable issue and still need clarification, you can write your question
in this issue. It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://github.com/CyconeraInc/cypress/issues/new/choose).
...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there
  ...
  the [bug tracker](https://github.com/CyconeraInc/cypress/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/CyconeraInc/cypress/issues/new/choose). (Since we can't be sure at this point
...
- Read the [documentation]() carefully and find out if the functionality is already covered, maybe by an individual
  configuration.
- Perform a [search](https://github.com/CyconeraInc/cypress/issues) to see if the enhancement has already been
