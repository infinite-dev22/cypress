...
def index_exam_types(request):
    if request.user.is_authenticated and request.user.is_superuser:
        try:
            ...
            return render(request, "admin_panel/assessments/index_exam_type.html", context)
...
def create_exam_type(request):
    if request.user.is_authenticated and request.user.is_superuser:
        if request.method == "POST":
            ...
            exam.save()
            return redirect("admin_exam_types")
        ...
        return render(request, "admin_panel/assessments/edit_exam_type.html", context)
    return redirect('login_admin_user')
...
def index_exams(request):
    if request.user.is_authenticated and request.user.is_superuser:
        try:
            ...
            return render(request, "admin_panel/assessments/index_exam_master.html", context)
        except ObjectDoesNotExist:
            context = {
                "exam_masters": None
            }
...
def create_exam(request):
    if request.user.is_authenticated and request.user.is_superuser:
        ...
        return render(request, "admin_panel/assessments/edit_exam_master.html", context)
    return redirect('login_admin_user')
...
def index_results(request):
    if request.user.is_authenticated and request.user.is_superuser:
        try:
            ...
            return render(request, "admin_panel/assessments/index_exam_results.html", context)
        except ObjectDoesNotExist:
            context = {
                "results": None
            }
...
def create_result(request):
    if request.user.is_authenticated and request.user.is_superuser:
        ...
        return render(request, "admin_panel/assessments/edit_exam_result.html", context)
    return redirect('login_admin_user')
...
def index_scores(request):
    if request.user.is_authenticated and request.user.is_superuser:
        try:
            ...
            return render(request, "admin_panel/assessments/index_exam_scores.html", context)
        except ObjectDoesNotExist:
            context = {
                "scores": None
            }
...
def create_score(request):
    if request.user.is_authenticated and request.user.is_superuser:
        ...
        return render(request, "admin_panel/assessments/edit_exam_score.html", context)
    return redirect('login_admin_user')
